    ...
    export class LeaderboardAppComponent extends React.Component<ILeaderboardAppProps, ILeaderboardAppState>{
        ...
        public render() {
            var columns = this.props.leaderboardColumns.map(i=> {
                return (<LeaderboardColumnComponent key={i.title} model={i} bountiesUrl={this.props.baseBountiesUrl + "?" + i.fromDate.toISOString() } />);
            });
...
var leaderboardItemsThisWeek = new Leaderboard.LeaderboardColumnModel(array, startOfWeek, "This Week");
...
var leaderboardColumnAllTime = new Leaderboard.LeaderboardColumnModel(allTimeArray, new Date(2016, 1, 1), "All Time");
...
if(homeElem){
    ReactDOM.render(<App leaderboardColumns={columns} baseBountiesUrl='/home/getbounties' />, homeElem); 
}
